            ...
            <article>
              ...
              <div className="bg-black text-white p-5">
                <p className="text-sm font-light leading-relaxed">
                  "What takes a typical team <strong>2 sprints</strong>, I deliver in <strong>1</strong> — same quality bar. AI doesn't replace judgment. It compresses execution time."
                </p>
              </div>
            </article>
