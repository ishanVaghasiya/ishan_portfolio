  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 pt-20 md:pt-28 pb-16 md:pb-24">
      ...
      <header className="min-h-[75vh] sm:min-h-[85vh] flex flex-col justify-between border-b technical-hairline pb-12 md:pb-16">
        ...
        {/* Top meta row */}
        <motion.div {...FADE_UP(0)} className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="mb-5 sm:mb-0 flex items-center gap-3 border border-black px-4 py-3 w-full sm:w-auto">
            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse block" />
            <span className="text-[11px] font-bold uppercase tracking-[0.15em] leading-snug">
          ...
          <motion.div {...FADE_UP(0.3)} className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
            {PROOF_STATS.map((s, i) => (
              <div key={i} className="bg-white border technical-hairline p-5 flex flex-col gap-1.5">
                ...
                <span className="text-[13px] uppercase tracking-widest text-black font-bold leading-tight">
                  {s.label}
                </span>
      ...
      <motion.section {...SECTION_ANIMATION} className="py-24 border-b technical-hairline">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 border border-gray-300 divide-y md:divide-y-0 md:divide-x divide-gray-300">
          {[
            {
              title: "Frameworks",
        ...
        <div className="divide-y technical-hairline">
          {[
            ...
            },
            {
              ...
              desc: "Built responsive interfaces with modern frontend tools and TypeScript — first production-grade TS experience.",
            },
            {
